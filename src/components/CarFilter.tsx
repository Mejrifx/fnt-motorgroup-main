...
const CarFilter: React.FC<CarFilterProps> = ({ onFilterChange }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 relative z-[9999999]">
      <div className="bg-white/90 lg:bg-white backdrop-blur-xl shadow-2xl border border-white/30 rounded-2xl lg:rounded-full overflow-visible relative z-[9999999]">
        <div className="flex flex-col lg:flex-row items-center justify-center px-3 lg:px-6 py-3 lg:py-3 gap-3 lg:gap-0">
          ...
          <div className="relative">
            ...
            {isMakeOpen && (
              <div className="absolute z-[9999999] top-full left-1/2 transform -translate-x-1/2 mt-2 bg-white border border-gray-200 rounded-2xl shadow-2xl max-h-80 overflow-y-auto min-w-48">
                <div className="py-2">
                  <button
                    onClick={() => {
