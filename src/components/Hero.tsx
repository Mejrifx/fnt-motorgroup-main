        ...
        <div className="animate-fade-in-up overflow-visible">
          ...
          <div className="hidden lg:block mb-8 md:mb-12" style={{ marginTop: '0px' }}>
            <img 
              ...
              style={{ transform: 'translateY(-35px) scale(1)' }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'translateY(-35px) scale(1.05)';
                e.currentTarget.style.transition = 'transform 0.3s ease';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(-35px) scale(1)';
              }}
            />
          </div>
