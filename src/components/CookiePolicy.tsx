            ...
            <div className="space-y-6">
              ...
              <Accordion>
                <AccordionItem 
                  ...
                  defaultOpen={true}
                >
                  <h4 className="font-semibold text-white mb-3">Purpose:</h4>
                  <p>
                  ...
                  <h4 className="font-semibold text-white mt-6 mb-3">Examples of essential cookies we use:</h4>
                ...
                >
                  ...
                  <h4 className="font-semibold text-white mt-6 mb-3">Third-party analytics services we may use:</h4>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      ...
                      <br />
                      <span className="text-sm text-gray-400">
                        Opt-out: <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Google Analytics Opt-Out Browser Add-On</a>
                      </span>
                    </li>
                  </ul>
                ...
                >
                  ...
                  <h4 className="font-semibold text-white mt-6 mb-3">Examples of functional cookies we may use:</h4>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                >
                  ...
                  <h4 className="font-semibold text-white mt-6 mb-3">Third-party advertising services we may use:</h4>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>Facebook Pixel / Meta Pixel:</strong> Tracks conversions, optimizes ads, and builds audiences for retargeting
                      <br />
                      <span className="text-sm text-gray-400">
                        Privacy Policy: <a href="https://www.facebook.com/privacy/explanation" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Meta Privacy Policy</a>
                      </span>
                    </li>
                    <li>
                      ...
                      <br />
                      <span className="text-sm text-gray-400">
                        Privacy Policy: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Google Privacy Policy</a>
                      </span>
                    </li>
                    <li>
                      ...
                      <br />
                      <span className="text-sm text-gray-400">
                        Privacy Policy: <a href="https://www.tiktok.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">TikTok Privacy Policy</a>
                      </span>
                    </li>
                  </ul>
                ...
                >
                  ...
                  <h4 className="font-semibold text-white mt-6 mb-3">Third-party social media platforms we use:</h4>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>Instagram:</strong> For embedded vehicle photos and social media links
                      <br />
                      <span className="text-sm text-gray-400">
                        Privacy Policy: <a href="https://help.instagram.com/519522125107875" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Instagram Privacy Policy</a>
                      </span>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <br />
                      <span className="text-sm text-gray-400">
                        Privacy Policy: <a href="https://www.facebook.com/privacy/explanation" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Facebook Privacy Policy</a>
                      </span>
                    </li>
                  </ul>
                ...
                >
                  ...
                  <h4 className="font-semibold text-white mt-6 mb-3">How to manage cookies by browser:</h4>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-gray-300 text-sm mt-1">
                        ...
                        <br />
                        <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Chrome Cookie Settings Help</a>
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm mt-1">
                        ...
                        <br />
                        <a href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Firefox Cookie Settings Help</a>
                      </p>
                    </div>
                    
                    <div>
                      <strong className="text-white">Safari (macOS):</strong>
                      <p className="text-gray-300 text-sm mt-1">
                        Preferences → Privacy → Manage Website Data
                        <br />
                        <a href="https://support.apple.com/en-gb/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Safari Cookie Settings Help</a>
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm mt-1">
                        ...
                        <br />
                        <a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-fnt-red underline hover:text-red-400">Edge Cookie Settings Help</a>
                      </p>
                    </div>
                  </div>
                ...
                <AccordionItem 
                  ...
                  legalBasis="N/A"
                >
                  <h4 className="font-semibold text-white mb-3">Session Cookies:</h4>
                  <p>
                  ...
                  <h4 className="font-semibold text-white mt-6 mb-3">Persistent Cookies:</h4>
                  <p>
