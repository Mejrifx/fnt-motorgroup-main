...
CREATE INDEX IF NOT EXISTS idx_cars_stock_status  ON cars(stock_status);
CREATE INDEX IF NOT EXISTS idx_cars_priority      ON cars(priority);
CREATE INDEX IF NOT EXISTS idx_cars_mot_expiry    ON cars(mot_expiry);
